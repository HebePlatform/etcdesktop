...
var IUniswapV2Pair = _interopDefault(require('@hebeswap/v2-core/build/IHebeswapV2Pair.json'));
...
var FACTORY_ADDRESS = '0x09fafa5eecbc11C3e5d30369e51B7D9aab2f3F53';
var INIT_CODE_HASH = '0xa036bc35f72d4331ca192979fb12e8a1f3260672aca44271ce35744fa5d66749';
...
Currency.ETHER = /*#__PURE__*/new Currency(18, 'ETC', 'EtherClassic');
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'HEBE-V2', 'Hebeswap V2');
  ...
  Router.swapCallParameters = function swapCallParameters(trade, options) {
    ...
    switch (trade.tradeType) {
      case exports.TradeType.EXACT_INPUT:
        if (etherIn) {
          methodName = useFeeOnTransfer ? 'swapExactETCForTokensSupportingFeeOnTransferTokens' : 'swapExactETCForTokens'; // (uint amountOutMin, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = useFeeOnTransfer ? 'swapExactTokensForETCSupportingFeeOnTransferTokens' : 'swapExactTokensForETC'; // (uint amountIn, uint amountOutMin, address[] calldata path, address to, uint deadline)
      ...
      case exports.TradeType.EXACT_OUTPUT:
        ...
        if (etherIn) {
          methodName = 'swapETCForExactTokens'; // (uint amountOut, address[] calldata path, address to, uint deadline)

          args = [amountOut, path, to, deadline];
          value = amountIn;
        } else if (etherOut) {
          methodName = 'swapTokensForExactETC'; // (uint amountOut, uint amountInMax, address[] calldata path, address to, uint deadline)
...
//# sourceMappingURL=hebeswap_sdk.cjs.development.js.map
